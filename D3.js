...
*/
let robot = structuredClone(starWarsCharacters);
for (i = 0; i < robot.length; i++) {
  const starwarsObj = robot[i];
  if (starwarsObj.gender === "n/a") {
    starwarsObj.gender == "robot";
  }
